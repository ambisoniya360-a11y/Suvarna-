  ...
  return (
    <html lang="en" className={inter.variable} suppressHydrationWarning>
      <head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800;900&family=Playfair+Display:ital,wght@0,400..900;1,400..900&family=Geist+Mono:wght@400;500;600&display=swap"
          rel="stylesheet"
        />
        <script
